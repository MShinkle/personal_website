...
*For more details and results, see my CVPR 2025 paper [Visualizing and Controlling Cortical Responses Using Voxel-Weighted Activation Maximization](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=da0OafkAAAAJ&sortby=pubdate&citation_for_view=da0OafkAAAAJ:ufrVoPGSRksC) or Chapter 2 ("Simulation of Brain Responses Using Whole-Network Features from Deep Neural Networks") of my [dissertation](https://search.proquest.com/openview/afad0c719d928c55d636640b71b28b94/1?pq-origsite=gscholar&cbl=18750&diss=y).*
